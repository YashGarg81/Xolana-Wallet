            ...
            rounded-b-[35px] px-3 md:px-20 py-4">
                <div className="flex items-center justify-start gap-5 cursor-pointer">
                    ...
                    <div className="hidden lg:flex items-center justify-center gap-3">
                        <a href='https://myfirstweb3wallet.vercel.app/' target='_blank' className='rounded cursor-pointer transition-transform transform active:scale-95 hover:bg-white/30 px-5 py-2 backdrop-blur-lg backdrop-saturate-150 shadow-lg border border-[#434348]'>Wallet</a>
